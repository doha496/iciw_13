...
class XDICIWAddDairy1 extends StatelessWidget {
  XDICIWAddDairy1({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_in8s0x =
    '<svg viewBox="22.5 334.5 1.0 22.0" ><path transform="translate(22.5, 334.5)" d="M 0 0 L 0 22" fill="none" stroke="#000000" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
